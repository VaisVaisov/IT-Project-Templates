...
│       ├── devcontainers/      # Dev-containers por familia de placa
│       │   ├── base/           # Arduino + ESP (PlatformIO + Clang)
│       │   ├── stm32/          # STM32 (+ herramientas ST-Link + GDB)
│       │   └── pico/           # Raspberry Pi Pico (+ picotool)
│       ├── .vscode/            # Configuración VS Code compartida
│       ├── arduino/            # Plantilla familia Arduino
│       ├── esp32/              # Plantilla familia ESP32
│       ├── esp8266/            # Plantilla familia ESP8266
│       ├── stm32/              # Plantilla familia STM32
│       └── pico/               # Plantilla Raspberry Pi Pico
├── python/
